...
$cfg['blowfish_secret']					= 'h\\]VPuRm>):E.Sg!9\")O!)2vJyW?]1w*' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_fA2vDcZEGRQpnPWeliHXUaF/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
